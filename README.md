...
Deployed and fully configured **GLPI** (Gestionnaire Libre de Parc Informatique) as a centralized IT Asset Management System from scratch for a large enterprise organization.
